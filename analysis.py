...
from sklearn.naive_bayes import BernoulliNB as BernoulliNB_sklearn, GaussianNB as GaussianNB_sklearn, MultinomialNB as MultinomialNB_sklearn
...
def main():
    ...
    multinomial_sklearn = MultinomialNB_sklearn()
    ...
    bernoulli_sklearn = BernoulliNB_sklearn()
    ...
    gaussian_sklearn = GaussianNB_sklearn()
